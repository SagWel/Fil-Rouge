                    ...
                    h={"100%"} w={"100%"}>
                        ...
                        bg={"#000000"}>
                            ...
                            style={{
                                ...
                                w={"100%"} maxW={"512px"}>
                                    <FormControl w={"100%"} pos={"relative"}>
                                        ...
                                        <Input name="email" type="email" id="email" autoComplete="email" value={email} required
                                        position={"relative"}
                            ...
                            <Box textAlign={"center"}>
                                ...
                                pos={"relative"}
                                display={"inline"} alignItems={"center"} gap={"0.25rem"}
                                paddingInline={"1.5rem"}
                                p={0}
                                minH={"3rem"} minW={"3rem"} h={"auto"}
                                whiteSpace={"nowrap"} verticalAlign={"baseline"}
                                fontFamily={"Inter,Arial,sans-serif"} fontWeight={"700"} fontSize={"0.875rem"}
                                lineHeight={"normal"} textDecor={"none"} color={"#ad47ff"} textTransform={"none"}
                                borderRadius={"0.75rem"}
                                outline={"transparent solid 2px"} outlineOffset={0}
                                transitionDuration={"200ms"} transitionProperty={"background-color,border-color,outline-color,color,fill,stroke,opacity,box-shadow,transform"}
