        ...
        >
            ...
            borderBottomColor={"#3a393d"} borderBottomStyle={"solid"} borderBottomWidth={"0.0625rem"}>
                ...
                color={"#fdfcfeff"}>
                    ...
                    paddingLeft={"8px"} paddingRight={"8px"} gap={"0.25rem"}
                    ...
                    height={"128px"}>
                        ...
                        <Link to={"/Instruments"}>
                            ...
                            _hover={{
                                ...
                                <Heading fontSize={"18px"} fontWeight={"700"}>Instruments</Heading>
                            </Flex>
                        </Link>
                        <Link to={"/Favoris"}>
                            <Flex 
                            ...
                            _hover={{
                                ...
                                <Heading fontSize={"18px"} fontWeight={"700"}>Favoris</Heading>
                            </Flex>
                        </Link>
                    </Flex>
            </Flex>
