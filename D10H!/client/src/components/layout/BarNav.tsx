...
const BarNav: React.FC<IBarNavProps> = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Box id="Links" p={"0 1rem 0px 1rem"} color={"#fdfcfeff"}>
          <Box
            id="D10H_!"
            paddingLeft={"105px"}
            fontSize={"1,125rem"}
        ...
        >
          ...
          >
            ...
            >
              <HomeIcon />
              <Heading fontSize={"1.125rem"} fontWeight={"700"}>
                Accueil
              </Heading>
            </Flex>
          </Link>
      ...
      <Box id="sidebar">
        <Box id="sidebar-visible">
          ...
          >
            ...
            <IconButton
              id="boutoun-new-scorbrary"
              aria-label="Ajouter un Scorbrary"
              isDisabled
              title="prochainement"
              padding={"0"}
              height={"2rem"}
        ...
        >
          ...
          >
            <Flex flexDirection={"column"}>
              ...
              <Box id="infos-scorbrary" padding={"1.5rem"}>
                <Flex
                ...
                >
                  ...
                  >
                    ...
                    <Input
                      placeholder={"Nom de la Scrobrary"}
                      maxLength={50}
                      paddingStart={"1rem"}
                      paddingInlineEnd={"0.75rem"}
                      h={"2rem"}
