...
const PlayeurMin: React.FC<IPlayeurMinProps> = () => {
  const { setOnPlay, setBackToStart, setNextMeasure, setPreviousMeasure } =
    usePlayScoreDispatch();
  ...
  const [onPlayWithCountdown, setOnPlayWithCountdown] =
  ...
  return (
    ...
    >
      <Flex id="info-piste" alignItems={"center"} width={"33%"} height={"100%"}>
        <Box
          id="cover"
          width={"2.5rem"}
          borderColor={"#3a393d"}
        ...
        >
          <Button
            aria-label="Retirer des coups de coeur"
            disabled
            title="prochainement"
            display={"inline-flex"}
            alignItems={"center"}
      ...
      >
        ...
        >
          ...
          <Box paddingLeft={"0.5rem"} position={"relative"} right={"0"}>
            <Text
              fontSize={"12px"}
              fontWeight={"400"}
              lineHeight={"16px"}
      ...
      >
        ...
        <Popover isOpen={isOpen}>
          ...
          <PopoverContent
            ...
            borderRadius={"0.5rem"}
            boxShadow={
              "rgba(0, 0, 0, 0.4) 0px 0px 25px 10px, rgba(0, 0, 0, 0.04) 0px 10px 10px -5px"
            }
            onMouseEnter={handleOpen}
            onMouseLeave={handleClose}
            _focusVisible={{
          ...
          >
            ...
            <PopoverBody paddingInline={"1rem"} py={"14px"}>
              <Slider
                value={volume}
                pos={"relative"}
                display={"flex"}
